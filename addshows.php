...
<body>
	<form action="addshowsIfo.php" method="post">
		...
		文章标题:<input type="text" name="stitle"><br><br>内容:<br>
		<textarea name="scon" rows="10" cols="30"></textarea><br><br>
			<input type="file" class="one" name="file" /><br><br>
				<div class="box">
					...
					?><br><br>
		<input type="submit" value="提交文章" disabled="disabled" class="sub">
